...
kstring::kstring(const wchar_t* str, ULONGLONG pool, ULONG tag) : kstring(str, 0, pool, tag) {
}

kstring::kstring(const wchar_t* str, ULONG count, ULONGLONG pool, ULONG tag) : m_Pool(pool), m_Tag(tag) {
	if (str) {
...
kstring::kstring(PCUNICODE_STRING str, ULONGLONG pool, ULONG tag) : m_Pool(pool), m_Tag(tag) {
